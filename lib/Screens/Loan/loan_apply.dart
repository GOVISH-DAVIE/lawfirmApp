...
class _LoanApplyState extends State<LoanApply> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      floatingActionButton: FloatingActionButton(onPressed: () => const LoanType().launch(context),
            ...
            child: Container(
              ...
              child: Column(
                ...
                children: [
                  ...
                  ButtonGlobal(buttontext: 'Apply', buttonDecoration: kButtonDecoration.copyWith(color: kMainColor), onPressed: ()=> const LoanDetails().launch(context),)
                ],
              ),
            ),
          ),
